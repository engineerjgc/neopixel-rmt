...
#ifndef CS_MOS_LIBS_NEOPIXEL_RMT_INCLUDE_MGOS_NEOPIXEL_RMT_H_
#define CS_MOS_LIBS_NEOPIXEL_RMT_INCLUDE_MGOS_NEOPIXEL_RMT_H_
...
#endif /* CS_MOS_LIBS_NEOPIXEL_RMT_INCLUDE_MGOS_NEOPIXEL_H_ */
